 ...
 */
final class Version20200802223525 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD user_id INT NOT NULL, ADD project_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note DROP user_id, DROP project_id');
